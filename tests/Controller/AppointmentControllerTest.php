...
class AppointmentControllerTest extends WebTestCase
{
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'appointment[dateTime]' => 'Something New',
            ...
            'appointment[planing]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getPlaning());
    }

...
class __TwigTemplate_364005a62f48a09033659d3fea0ec4c0 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table items-center text-center w-1/2\">
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["contacts"]) || array_key_exists("contacts", $context) ? $context["contacts"] : (function () { throw new RuntimeError('Variable "contacts" does not exist.', 18, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["contact"]) {
            ...
            yield "</td>
                <td>";
            // line 21
            ((CoreExtension::getAttribute($this->env, $this->source, $context["contact"], "createdAt", [], "any", false, false, false, 21)) ? (yield Twig\Extension\EscaperExtension::escape($this->env, Twig\Extension\CoreExtension::dateFormatFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["contact"], "createdAt", [], "any", false, false, false, 21), "d/m/Y"), "html", null, true)) : (yield ""));
            yield "</td>
                <td>";
            // line 22

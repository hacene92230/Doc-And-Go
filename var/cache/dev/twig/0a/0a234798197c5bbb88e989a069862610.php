...
class __TwigTemplate_fbacf31d663050ce98e5dc31ef97113f extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        yield "    <h1 class=\"text-center text-2xl mt-10 font-bold\">Nous contacter</h1>
...
{% block title %}Nous contacter {{ parent() }} {% endblock %}

{% block body %}
    <h1 class=\"text-center text-2xl mt-10 font-bold\">Nous contacter</h1>

    {{ include('contact/_form.html.twig') }}
{% endblock %}
", "contact/new.html.twig", "/var/www/html/doc-and-go/templates/contact/new.html.twig");
    }
}

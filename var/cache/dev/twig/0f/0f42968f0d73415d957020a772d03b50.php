...
class __TwigTemplate_7354a5e63565d72b84b6ec835f883684 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container px-6 text-center\">    
        ...
        yield Twig\Extension\EscaperExtension::escape($this->env, (isset($context["next_year"]) || array_key_exists("next_year", $context) ? $context["next_year"] : (function () { throw new RuntimeError('Variable "next_year" does not exist.', 27, $this->source); })()), "html", null, true);
        yield "
            </p>
        </div>
...
";
    ...
    {
        return array (  81 => 27,  70 => 19,  66 => 18,  62 => 17,  44 => 1,);
    }

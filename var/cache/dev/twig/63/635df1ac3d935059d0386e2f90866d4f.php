...
<div class=\"relative\">
    <button class=\"rectangle-button bg-white text-gray-800 text-sm font-semibold shadow-md hover:shadow-lg focus:outline-none\" id=\"administration-menu-toggle\">
        Administration <i class=\"fas fa-caret-down\"></i>
    </button>

    <!-- Dropdown menu administration -->
    <div class=\"absolute right-0 mt-2 w-full bg-white rounded-md shadow-lg z-10 hidden\" id=\"administration-menu\">
        <div class=\"py-1\" role=\"none\">
            <!-- Section Utilisateurs -->
            <div class=\"relative \">
                <button class=\"block w-full pl-2 text-left text-sm text-gray-700 hover:bg-gray-100 focus:outline-none\" id=\"users-menu-toggle\">
                    Utilisateurs <i class=\"fas fa-caret-down absolute right-4\"></i>
                </button>
                <div class=\"absolute right-0   w-48  bg-white rounded-md shadow-lg z-10 hidden\" id=\"users-menu\">
...
\t\t\t<a href=\"#contact-index\" class=\"block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100\" role=\"menuitem\">Demandes de contact</a>
            ...
            <!-- Section Paramètres -->
            <div class=\"relative\">
                <button class=\"block w-full pl-2 text-left text-sm text-gray-700 hover:bg-gray-100 focus:outline-none\" id=\"settings-menu-toggle\">
                    Paramètres <i class=\"fas fa-caret-down absolute right-4\"></i>
                </button>
                <div class=\"absolute right-0  w-48 bg-white rounded-md shadow-lg z-10 hidden\" id=\"settings-menu\">
            ...
            <!-- Section Journaux -->
            <div class=\"relative\">
                <button class=\"block w-full pl-2 text-left text-sm text-gray-700 hover:bg-gray-100 focus:outline-none\" id=\"logs-menu-toggle\">
                    Journaux <i class=\"fas fa-caret-down absolute right-4\"></i>
                </button>
                <div class=\"absolute right-0 mt-2 w-full bg-white rounded-md shadow-lg z-10 hidden\" id=\"logs-menu\">

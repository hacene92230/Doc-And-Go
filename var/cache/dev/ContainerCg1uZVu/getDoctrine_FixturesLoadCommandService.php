...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ReasonFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/SpecialityFixtures.php';
        ...
        $a->addFixtures([['fixture' => new \App\DataFixtures\ReasonFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\SpecialityFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\UserFixtures(($container->privates['security.user_password_hasher'] ?? $container->load('getSecurity_UserPasswordHasherService'))), 'groups' => []]]);
